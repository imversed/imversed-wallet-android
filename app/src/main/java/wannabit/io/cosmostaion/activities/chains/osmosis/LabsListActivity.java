...
public class LabsListActivity extends BaseActivity implements TaskListener {
    ...
    public void onStartSwap(String inputCoinDenom, String outCoinDenom, long poolId) {
        ...
        BigDecimal txFee = getBaseChain().getGasFeeEstimateCalculator().calc(getBaseChain(), CONST_PW_TX_OSMOSIS_SWAP);
    ...
    public void onCheckStartJoinPool(long poolId) {
        ...
        BigDecimal feeAmount = getBaseChain().getGasFeeEstimateCalculator().calc(getBaseChain(), CONST_PW_TX_OSMOSIS_JOIN_POOL);
    ...
    public void onCheckStartExitPool(long poolId) {
        ...
        BigDecimal feeAmount = getBaseChain().getGasFeeEstimateCalculator().calc(getBaseChain(), CONST_PW_TX_OSMOSIS_EXIT_POOL);
    ...
    public void onFetchPoolListInfo() {
        ...
        new OsmosisPoolListGrpcTask(getBaseApplication(), this, getBaseChain()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
        new OsmosisIncentivizedPoolsGrpcTask(getBaseApplication(), this, getBaseChain()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
        new OsmosisActiveGaugesGrpcTask(getBaseApplication(), this, getBaseChain()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
        new OsmosisLockupStatusGrpcTask(getBaseApplication(), this, getBaseChain(), getAccount().address).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }
