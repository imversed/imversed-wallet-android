...
public class IBCSendActivity extends BaseBroadCastActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitle.setText(R.string.str_ibc_send_c);
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                if (i == 0) {
                    ...
                    mTvStep.setText(R.string.str_ibc_transfer_step_0);
                } else if (i == 1) {
                    mIvStep.setImageResource(R.drawable.step_2_img);
                    mTvStep.setText(R.string.str_ibc_transfer_step_1);
                    ...
                    mTvStep.setText(R.string.str_ibc_transfer_step_2);
                    if (mPageAdapter.mCurrentFragment instanceof IRefreshTabListener) {
                        ((IRefreshTabListener) mPageAdapter.mCurrentFragment).onRefreshTab();
                    }
                } else if (i == 3) {
                    mIvStep.setImageResource(R.drawable.step_4_img);
                    mTvStep.setText(R.string.str_ibc_transfer_step_3);
                    if (mPageAdapter.mCurrentFragment instanceof IRefreshTabListener) {
                        ((IRefreshTabListener) mPageAdapter.mCurrentFragment).onRefreshTab();
                    }
                } else if (i == 4) {
                    mIvStep.setImageResource(R.drawable.step_5_img);
                    mTvStep.setText(R.string.str_ibc_transfer_step_4);
                    if (mPageAdapter.mCurrentFragment instanceof IRefreshTabListener) {
                        ((IRefreshTabListener) mPageAdapter.mCurrentFragment).onRefreshTab();
                    }
                }
