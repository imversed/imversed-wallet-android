...
public class TxGravityCreatePoolHolder extends TxHolder {
    ...
    public void onBindMsg(Context c, BaseData baseData, BaseChain baseChain, ServiceOuterClass.GetTxResponse response, int position, String address, boolean isGen) {
        ...
        try {
            ...
            WDp.showCoinDp(baseData, coin0, itemGravityCreatePoolDepositSymbol1, itemGravityCreatePoolDepositAmount1, baseChain);
            WDp.showCoinDp(baseData, coin1, itemGravityCreatePoolDepositSymbol2, itemGravityCreatePoolDepositAmount2, baseChain);
