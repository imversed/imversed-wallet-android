    ...
    public void onBindMsg(Context c, BaseData baseData, BaseChain baseChain, ServiceOuterClass.GetTxResponse response, int position, String address, boolean isGen) {
        ...
        try {
            ...
            if (outCoin0 != null && outCoin1 != null) {
                WDp.showCoinDp(baseData, outCoin0, itemExitPoolTokenOutSymbol1, itemExitPoolTokenOutAmount1, baseChain);
                WDp.showCoinDp(baseData, outCoin1, itemExitPoolTokenOutSymbol2, itemExitPoolTokenOutAmount2, baseChain);
            } else {
            ...
            if (inCoin != null) {
                WDp.showCoinDp(baseData, inCoin, itemExitPoolTokenInSymbol, itemExitPoolTokenInAmount, baseChain);
            } else {
