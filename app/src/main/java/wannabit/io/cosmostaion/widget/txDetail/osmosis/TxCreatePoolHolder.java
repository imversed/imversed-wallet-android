...
public class TxCreatePoolHolder extends TxHolder {
    ...
    public void onBindMsg(Context c, BaseData baseData, BaseChain baseChain, ServiceOuterClass.GetTxResponse response, int position, String address, boolean isGen) {
        ...
        try {
            ...
            WDp.showCoinDp(baseData, coin0, itemCreatePoolAssetSymbol1, itemCreatePoolAssetAmount1, baseChain);
            WDp.showCoinDp(baseData, coin1, itemCreatePoolAssetSymbol2, itemCreatePoolAssetAmount2, baseChain);
