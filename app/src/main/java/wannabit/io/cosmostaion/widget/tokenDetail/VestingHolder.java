...
public class VestingHolder extends BaseHolder {
    ...
    private void onBindGRPC(Context c, BaseData baseData, String denom) {
        ...
        mVestingGap0.setText(WDp.getUnbondingTimeleft(vps.get(0).getLength()));
        ...
        if (vps.size() > 1) {
            ...
            mVestingGap1.setText(WDp.getUnbondingTimeleft(vps.get(1).getLength()));
        ...
        if (vps.size() > 2) {
            ...
            mVestingGap2.setText(WDp.getUnbondingTimeleft(vps.get(2).getLength()));
        ...
        if (vps.size() > 3) {
            ...
            mVestingGap3.setText(WDp.getUnbondingTimeleft(vps.get(3).getLength()));
        ...
        if (vps.size() > 4) {
            ...
            mVestingGap4.setText(WDp.getUnbondingTimeleft(vps.get(4).getLength()));
